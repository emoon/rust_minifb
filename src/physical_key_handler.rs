...
impl PhysicalKeyHandler {
    pub fn new() -> PhysicalKeyHandler {
        PhysicalKeyHandler {
            key_callback: None,
            keys: [false; 512],
            keys_prev: [false; 512],
    ...
    #[inline]
    pub fn set_key_state(&mut self, key: Scancode, state: bool) {
        self.keys[key as usize] = state;
    }

    pub fn get_keys(&self) -> Option<Vec<Scancode>> {
        let mut index: u16 = 0;
    ...
    pub fn get_keys_pressed(&self, repeat: KeyRepeat) -> Option<Vec<Scancode>> {
        let mut index: u16 = 0;
        let mut keys: Vec<Scancode> = Vec::new();
    ...
    #[inline]
    pub fn is_key_pressed(&self, key: Scancode, repeat: KeyRepeat) -> bool {
        return Self::key_pressed(self, key as usize, repeat);
    }

    #[inline]
    pub fn is_key_released(&self, key: Scancode) -> bool {
